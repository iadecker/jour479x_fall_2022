...
ggplot() + geom_line(data=os_record_wins_losses_separate, aes(x=Wins, y=Year))
```
...
ggplot() + geom_line(data=fins_record_wins_losses_separate, aes(x=Wins, y=Year))


ggplot() + geom_line(data=os_record_wins_losses_separate, aes(x=Year, y=Wins))
```
