...
#Graphing the wins by year using a line chart
ggplot(fins_record_wins_losses_separate, aes(x=Year, y=Wins, group=Tm)) +         
  geom_line() +
  geom_point()
```
#In the 2018 offseason, the Marlins traded away Dee Gordon, Christian Yelich, Giancarlo Stanton and Marcel Ozuna. They won 63 the next season before winning 57 the following year. But in 2021 and then again in 2022, the team jumped up from 67 to 69 wins. Now, this is still a pretty bad baseball team, but it is winning more games. Using just wins, it looks like the selloff the Marlins undertook in 2018 is not paying off yet.
