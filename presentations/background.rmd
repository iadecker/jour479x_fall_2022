...
#Nats wins
nats_2019_record <- bref_team_results('WSH', 2019) %>%
    filter(Gm == '162')

nats_2020_record <- bref_team_results('WSH', 2020) %>%
    filter(Gm == '60')

nats_2021_record <- bref_team_results('WSH', 2021) %>%
    filter(Gm == '162')

nats_2022_record <- bref_team_results('WSH', 2022) %>%
    filter(Gm == '162')
