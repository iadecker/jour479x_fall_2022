...
ggplot() + geom_line(data=os_record_wins_losses_separate, aes(x=Year, y=Wins, group=Tm))
```
...
#Graphing the wins by year using a line chart
ggplot() + geom_line(data=fins_record_wins_losses_separate, aes(x=Year, y=Wins, group=Tm))
```
