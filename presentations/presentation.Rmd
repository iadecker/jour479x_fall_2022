...
ggplot() + 
  ...
  coord_flip() +
   labs(title="What does 'blowing up' a roster actually mean in Major League Baseball?", subtitle="The Washington Nationals traded fewer players than other 'rebuilding' teams but had the league's worst record.", caption="Source: Baseball-Reference | By Ian Decker")
```
