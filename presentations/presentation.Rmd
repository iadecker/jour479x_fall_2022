...
ggplot(nats_record_wins_losses_separate, aes(x=Year, y=win_percentage, group=Tm)) +         
  ...
  geom_point(colour='red') +
   labs(title="Have the Washington Nationals ever been this bad?", subtitle="2022 was the worst season in Washington baseball history, so fans could be in for a lengthy rebuild.", caption="Source: Baseball-Reference | By Ian Decker")
```
