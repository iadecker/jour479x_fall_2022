...
One of the earliest questions I wanted to ask was how certain refs impact the game. Should teams be weary of a certain official? To answer this question, I graphed the top-25 refs in terms of games worked and looked at their average fouls. I found that the Triple G Crew is one nasty bunch. Overall, the top three referees in terms of average fouls were Roy Gulbeyan, Felicia Grinter and Brian Garland, so fans watching a game in which these three worked would probaly hear a lot of the whistle. Interestingly enough, the fourth official, Talisa Green, also has a last name that begins with G... weird.
...
Here are the teams who averaged less fouls as the season went on: Indiana, Iowa, Michigan, Nebraska, Ohio State, Purdue and Wisconsin. 
...
Less fouls: Illinois, Michigan, Michigan State, Minnesota, Northwestern, 
...
Starting with the SEC, take a look at South Carolina, the national champion, which saw an increase in average fouls later in the season at home. We see again one of the limitations of this data in the awa dataframe — the graph didn't pull in SC's results for either March or April. Still, in looking at February, the Gamecocks seemed to be averaging fewer fouls than the previous month.
...
ggplot() + 
  ...
  labs(
    ...
    y="Average Fouls")
```
I swear there was no reason to me doing the ACC last... seriously! The main school I want to point out is Louisville, another final four team. The Cardinals grade out pretty well both at home and away, which contributed to their success. I also want to look at two teams (Clemson and Florida State) because they aren't so great at home and go against this home-court advatnage theory I've got cooking. In fact, both teams are closer to league average in their away games... interesting. Also, let's look at Miami, which is pretty solid at home but starts the season below average in away games before going way above but finishes the season back below the avergae. The ACC also probably has the most teams hovering around average of all six conferences at home, wihch may suggest it is the conference, for better (competitive play and integrity of the game) or worse (for fans and individual teams), that has the most consistent officiating.
