...
This seems kind of weird. This model loves Purdue but hates OSU. In adding team and opponent score, this model likes squads with strong records, and Purdue has a bunch of 3-0 wins, whereas OSU has a lot of 0-3 losses combined with 3-0 wins. As such, Purdue has a strong teamscorezscore (1.46) and OSU has a weak one (-0.11).
